...
description: >
  ...
  вызывай `1c-tester` — он выбирает уровень: разовое чтение значения или счётчика закрывается ступенью 2
  (батч ENTERPRISE + раннер-EPF, без публикации и без отладочного расширения), повторяемый и интерактивный
  доступ — по `references/data-access-verification.md` (автономный сервер, поправки на кодировку кириллицы,
