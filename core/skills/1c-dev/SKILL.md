...
description: >
  ...
  вызывай `1c-tester`, у него готовый воспроизводимый путь (`references/data-access-verification.md` —
  автономный сервер, поправки на кодировку кириллицы, диагностика по коду ответа); не изобретай доступ вручную
